...
<Tldr>
  Over a Christmas holiday sprint, a friend and I built a playable web version of Farkle in about an
  hour. GPT-5.2-Codex handled the core game build, GPT Image Gen created character art, and Suno
  gave us a nostalgic chiptune theme.
</Tldr>
