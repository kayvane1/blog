...
<Tldr>
  ...
  call. L3 is the database itself — the source of truth, but hundreds of milliseconds away over the
  network. The pattern has a name: _singleflight with a distributed lock and a notify channel_.
</Tldr>
